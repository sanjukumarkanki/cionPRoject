...
# Types of Scans Array 
$typeofscansarr = [
    ["Whole Body Analog Pet CT scan", "Rs 18000/-", "Rs.10999/-"],
    ["Whole Body Digital Pet CT Scan", "Rs 20000/-", "Rs.20999/-"],
...
$carouselItems = [
    ...
    [
        "question" => "Is there a neurology center nearby?",
        "answer" => "Explore local medical centers specializing in neurology for expert consultations and treatments."
    ],        [
        "question" => "Where can I get a PET scan in Vizag?",
        "answer" => "At Cion Cancer Clinic, we have facilities in Vizag, making it convenient for you."
    ],
...
# Locations Array
$locationContainer = [['assests\Group 35750.png', 'Chinnagadili'], ['assests\Group 35750.png', 'MVP Colony'], ['assests\Group 35750.png', 'Jagadamba Centre']];
?>